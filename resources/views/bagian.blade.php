        ...
        <div class="row">
            <div class="col-12 col-lg-2 col-sm-9 d-flex">
                <div class="card flex-fill">
                    <a href="/bagian/create" class="btn btn-primary">Tambah Bagian</a>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="card flex-fill">
                    ...
                    <table class="table table-hover my-0">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th class="d-none d-xl-table-cell">Nama Bagian</th>
                                <th>Status</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td><a style="text-decoration: none; color:rgb(71, 177, 68);" href="/bagian/{{ $dt->id }}">{{ ucwords($dt->nama_bagian) }}</a></td>
