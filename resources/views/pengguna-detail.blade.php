                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-body">
                        <form action="/bagian/create" class="form" method="post">
                            ...
                            <div class="col-12 mb-2" >
                                <input type="text" name="username" id="nama-bagian" class="form-control" placeholder="Bagian" value="{{$data->username }}" readonly>
                            </div>
                            <label for="nama-bagian">Bagian</label>
                            <div class="col-12 mb-2" >
                                @php
                                    $bagian = \App\Bagian::where('id',$data->bagian)->first();
                                @endphp
                                <input type="text" name="bagian" id="nama-bagian" class="form-control" placeholder="Bagian" value="{{$bagian->nama_bagian }}" readonly>
                            </div>
                            ...
                            <div class="col-12 mb-2" >
                                <a href="/pengguna/edit/{{ $data->id }}" class="btn btn-info">Edit</a>
                            </div>
                        </form>
                    </div>
                </div>
