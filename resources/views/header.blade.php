	...
	<nav id="sidebar" class="sidebar js-sidebar">
		<div class="sidebar-content js-simplebar">
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-item">
					<a class="sidebar-link {{ $menu == 'dashboard' ?  'active-menu' : ''}}" href="/guest/dashboard">
						<i class="align-middle" data-feather="monitor"></i> <span class="align-middle">Dashboard</span>
					</a>
				</li>
			</ul>
			...
			<ul class="navbar-nav navbar-align">
				...
				<li class="nav-item dropdown">
					...
					<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
						...
						@else
						<span class="text-dark">{{ session('guest')['nama'] }}</span>
						@endif
					</a>
					<div class="dropdown-menu dropdown-menu-end">
						...
						@else
						<a class="dropdown-item" href="/logout-guest">Log out</a>
						@endif
					</div>
				</li>
			</ul>
